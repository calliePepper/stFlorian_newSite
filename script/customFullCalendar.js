		...
		function renderEvents(events, modifiedEventId) {
            ...
            for (i in displayeventlist) {
                ...
                if ( evMonth == visMonth && evYear == visYear) {
                    ...
                    if ( displayeventlist[i].location ) {
                    	eventLocation          = htmlEscape(displayeventlist[i].location);
                    } else {
                    	eventLocation = '';
                    }
                    ...
                    // otherwise do the opposite
                        eventdisplay = $("<li class='fc-agendaList-item'>"+
                                            ...
                                            "<div class='fc-agendaList-eventDetails'>"+
                                              ...
                                              ( eventLocation == ''? "<div class='fc-eventlist-loc'>" + htmlEscape(eventLocation) + "</div>": "")+
